  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "    output.eval_js(\"window.open('https://github.com/N-aksif-N/MineColab_Improved/releases/latest')\")\n",
        "    raise Exception(\"Execution stopped: Version out of date. Obtain the latest version here: https://github.com/N-aksif-N/MineColab_Improved/releases/latest\")\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "  elif command == \"GetServerTypes\": return ['vanilla','snapshot','paper','purpur','mohist', \"arclight\",'velocity', 'banner', 'fabric',\"folia\", 'forge',\"neoforge\", 'bedrock']\n",
        ...
        "  elif server_type == 'neoforge': jarname = \"neoforge-installer.jar\"\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "dir1='\"'+\"/content/drive/MyDrive/minecraft/\"+server_name+'\"'\n",
        "#!echo\n",
        "%cd /content/drive/MyDrive/minecraft/\n",
        "!echo $server_name{/dimension,/world}*\n",
        "!rsync -ah --info=progress2 \"$server_name\" \"backup/$server_name_$(date +%F-%H_%M_%S)\""
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        "        # Make run.sh running\n",
        "        if exists(f'{drive_path}/{server_name}/eula.txt'): LOG('Run the server again to finished installing.')\n",
        ...
        "    ! sudo apt-get -y install openjdk-21-jre-headless  &>/dev/null && echo 'Openjdk21 is working correctly, you are good to go.' || \"Openjdk21 doesn't seem to be installed or isn't working, falling back to java 11\\nYou might experience reduced performance. Neoforge might fail to launch.\"\n",
        "    environ[\"JAVA_HOME\"] = \"/usr/lib/jvm/java-21-openjdk-amd64\"\n",
        ...
        "      ! sudo apt-get -y install openjdk-17-jre-headless &>/dev/nulll && echo 'Openjdk17 is working correctly, you are good to go.' || echo \"Openjdk17 doesn't seem to be installed or isn't working, falling back to java 11\\nYou might experience reduced performance. Mohist 1.18.2 to 1.20.2 might fail to launch.\"\n",
        "      environ[\"JAVA_HOME\"] = \"/usr/lib/jvm/java-17-openjdk-amd64\"\n",
        "      ! update-alternatives --set java /usr/lib/jvm/java-17-openjdk-amd64/bin/java\n",
        "\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "tunnel_service = \"playit\" # @param [\"Leave as it is\", \"argo\", \"zrok\", \"playit\", \"localtonet\", \"localxpose\", \"ngrok\", \"tailscale\", \"minekube-gate\"]\n",
        "\n",
        "serverconfig = load(open(SERVERCONFIG));\n",
